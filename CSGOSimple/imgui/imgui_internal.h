...
namespace ImGui
{
	...
	IMGUI_API bool          ButtonCustomIcon(const char* label, const char* labelIcon, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool invertGradient = false);
	IMGUI_API bool          ButtonCustom(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool invertGradient = false);

...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool blackbackground, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginTransparent(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, bool visible = true);
    IMGUI_API void          End();
	...
	IMGUI_API bool          ButtonGradient(const char* label, const ImVec2& size = ImVec2(0, 0));    // button

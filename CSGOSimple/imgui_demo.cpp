...
void ImGui::ShowDemoWindow(bool* p_open)
{
	...
	if (!ImGui::Begin("ImGui Demo", false, p_open, window_flags))
	{
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
	...
	if (ImGui::Begin("Example: Simple overlay", false, p_open, (corner != -1 ? ImGuiWindowFlags_NoMove : 0) | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav))
	{
...
static void ShowExampleAppWindowTitles(bool*)
{
	...
	ImGui::Begin("Same title as another window##1", false);
	ImGui::Text("This is window 1.\nMy title is the same as window 2, but my identifier is unique.");
	ImGui::End();

	ImGui::SetNextWindowPos(ImVec2(100, 200), ImGuiCond_FirstUseEver);
	ImGui::Begin("Same title as another window##2", false);
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
	...
	if (ImGui::BeginTabBar("##TabBar"))
	{
		...
		///	if (draw_bg)
		///		ImGui::backgrou()->AddCircle(window_center, window_size.x * 0.6f, IM_COL32(255, 0, 0, 200), 32, 10);
		//	if (draw_fg)
...
void ShowExampleAppDocuments(bool* p_open)
{
	...
	if (!ImGui::Begin("Example: Documents", false, p_open, ImGuiWindowFlags_MenuBar))
	{
		ImGui::End();
		return;
	}

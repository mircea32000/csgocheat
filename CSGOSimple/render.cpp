...
void Render::GetFonts() {
	...
	g_pIcons = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(
		niggerlicious_compressed_data,
		niggerlicious_compressed_size,
		25.f);
...
void Render::BeginScene() {
	...
	if (g_Options.misc_watermark) //lol
		Render::Get().RenderText("ANTION", 10, 5, 13.f, g_Options.color_watermark, false, true, g_pSecondFont);

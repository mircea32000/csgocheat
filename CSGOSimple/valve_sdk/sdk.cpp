...
namespace Interfaces
{
    ...
    void Initialize()
    {
		...
		auto localizeSysFactory = get_module_factory(GetModuleHandleW(L"localize.dll"));
		auto filesystem_stdio = get_module_factory(GetModuleHandleW(L"filesystem_stdio.dll"));
		...
		g_Localize            = get_interface<ILocalize>           (localizeSysFactory, "Localize_001");
		g_FileSystem         = get_interface<IFileSystem>         (filesystem_stdio, "VFileSystem017");

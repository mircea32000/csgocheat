...
public:
	...
	CEconItemDefinition* GetGetStaticData();
...
public:
	...
	NETVAR(bool, m_bInReload, "DT_BaseCombatWeapon", "m_bInReload");//m_bInReload


	CCSWeaponInfo* GetCSWeaponData();
	std::string   GetWeaponIcon();
	bool HasBullets();
	bool CanFire();
	bool IsGrenade();
	bool IsKnife();
...
public:
	...
	NETVAR(bool, m_bHasHelmet, "DT_CSPlayer", "m_bHasHelmet");//m_bInReload

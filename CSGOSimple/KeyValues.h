...
public:
	...
	void SetUint64(const char* keyName, uint64 value); void SetUint64(const char* keyName, int value, int value2);
...
public:
	...
	void LoadFromBuffer
	(
		const char* resourceName, const char* pBuffer, void* pFileSystem = nullptr,
		const char* pPathID = NULL, void* pfnEvaluateSymbolProc = nullptr
	);*/
};
